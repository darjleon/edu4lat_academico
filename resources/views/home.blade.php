        ...
        <div class="flex flex-wrap text-left">
            <div class="px-8 py-6 lg:w-1/3 md:w-full">
                <div class="p-6 bg-gray-200 rounded-md">
                    <h2 class="text-lg font-semibold text-gray-700 lg:text-2xl title-font"> Curso Alfa
                    </h2>
            ...
            <div class="px-8 py-6 lg:w-1/3 md:w-full">
                <div class="p-6 bg-gray-200 rounded-md">
                    <h2 class="text-lg font-semibold text-gray-700 lg:text-2xl title-font"> Curso Omega
                    </h2>
                    <div class="items-center justify-center w-full py-4 font-sans bg-blue-darker">
                        <div
                            class="flex flex-row w-full max-w-lg overflow-hidden leading-normal bg-white rounded shadow-lg">
            ...
            <div class="px-8 py-6 lg:w-1/3 md:w-full">
                <div class="p-6 bg-gray-200 rounded-md">
                    <h2 class="text-lg font-semibold text-gray-700 lg:text-2xl title-font"> Curso Gama
                    </h2>
                    <div class="items-center justify-center w-full py-4 font-sans bg-blue-darker">
                        <div
                            class="flex flex-row w-full max-w-lg overflow-hidden leading-normal bg-white rounded shadow-lg">
